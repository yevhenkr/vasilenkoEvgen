    ...
    <footer className={s.footer}>
      <div className={s.container}>
        ...
        <div className={s.socialIcons}>
          ...
          <div className={s.socialIcon}>
            <a
              href={'https://www.codewars.com/users/yevhenkr'}
              rel={'noreferrer'}
              target={'_blank'}
            >
              <svg
        ...
        <small className={s.copyright}>© 2024 All Rights Reserved.</small>
      </div>
    </footer>
  )
}
